...
Similarly, in the image below, the high resolution result is impressive but the prediction shows some problems separating the carpet from the cat body. They appear in plane as if the would belong to the same thing and they even share the same texture, leading to the impression of a somewhow  wrong perspective. 

![](/images/low_res2.png "original, low res image")
![](/images/predicted2.png "image improved via neural net")

It will be interesting to see if and how such artifacts and subtle details will be overcome in the future.
